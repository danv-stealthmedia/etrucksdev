...
gulp.task('watch', function () {
	...
	gulp.watch([`${paths.less}/**/*.less`, `${paths.less}/*.less`], gulp.series('styles'));
	gulp.watch(
		[
			`${paths.dev}/js/**/*.js`,
			'js/**/*.js',
...
gulp.task('styles', function (callback) {
	gulp.series('less', 'minifycss')(callback);
});

// Run:
// gulp combine-css
// theme.css includes everything that comes with understrap
// main.css includes everything thats in less folder
// Combine theme.css and main.css file into styles.css

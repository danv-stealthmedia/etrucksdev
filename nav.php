		...
		<div class="row align-items-center">
			<div class="col-auto">
				<div id="site-branding">
					<a id="header-logo" class="" href="<?php echo esc_url(home_url('/')); ?>"
							title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home">
						<svg xmlns="http://www.w3.org/2000/svg" width="175.265" height="69.151"
								viewBox="0 0 175.265 69.151">
							<defs>
								<style>.alogo {
										fill: #c6383f;
									}
			...
			<div class="col">
				<div id="site-menu" class="text-center desktop-menu desktop animation-element" role="navigation"
						itemscope itemtype="https://schema.org/SiteNavigationElement">
					<?php wp_nav_menu(['theme_location' => 'header', 'menu_id' => 'main-menu', 'depth' => 2]); ?>
				</div>
